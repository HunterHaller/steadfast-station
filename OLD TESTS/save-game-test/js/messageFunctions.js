...
function sendMessage(Message) {
  ...
  if (localStorage.buttonsActive == 1) { //if ready to send messages,
    ...
    if (Message.messID == "T1") { //Maintenance
      ...
      setTimeout(sendExtraMessage, 5000, messC6);
      setTimeout(messageStep, 15000, messT13, messT14, messC7);
      ...
      setTimeout(messageStep, 8000, messT15, messT16, messC8);
    } else if (Message.messID == "T14"){
      setTimeout(messageStep, 8000, messT15, messT16, messC9);
      ...
      setTimeout(makeWindow, 6000, antnnsMessage);
    }
  }
}
