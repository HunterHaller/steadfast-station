...
function stopOrientation() {
  ...
  if (visible == "Etheras" && thrusterDone == 0) {
    ...
    progress = 3;
    thrusterDone = 1;
  } else if (visible == "No objects" && phase2 == 1 && thrustersDestroyed == 0){
    ...
    setTimeout(sendExtraMessage, 20000, messC15);
    setTimeout(sendExtraMessage, 26000, messC16);
    thrustersDestroyed = 1;
  }
}
