...
let readoutIcon = new Icon (650, 540, "text.png", "STATUS", "readoutIcon");
...
let assistHint1 = new Window (550, 400, 145, 552, "ASSIST-HINT", "<p>Hey there!  I'm your virtual Assistant, here to guide you through the task of fixing up this OCW station.  Looks like you'll want to recharge the station's main power core first.  They usually get solar power, but this one's a little low still.  Type 'power' to get started, and of course, use '?' to get extra info on useful commands!</p><p>PS: You'll also note that another window should have opened with a copy of this message in it.  That window will keep a log of all messages I send you in case you want to refer back to them later.  Find it again with the appropriate icon below!", "assistHint1");
