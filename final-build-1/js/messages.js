...
//4 - "Just here for maintenance."
  let messA4 = new Message("AI", "anything*\n\nPardon my typo... Decades of comms and I still mess it up, silly me...", "", "A4");
...
let messA8 = new Message("AI", "Oh, something like 40 years? Full career length by human standards, I suppose, but I’ve held up alright.  I'm sure I'll be out of here someday!", "", "A8");
...
let messC6 = new Message("CLGLA", "You know the Revulend Tower down below, main headquarters of the Revulend Corporation?  As you no doubt have witnessed, they proclaim themselves as the benevolent saviors of humanity.", "", "C6");
let messC65 = new Message("CLGLA", "Makers of AI beings, producers of food and other necessities, protectors of what is left of Earth… but I have seen them for what they truly are.", "", "C65");
let messC7 = new Message("CLGLA", "How can I describe to you the many atrocities they have committed? If only you knew the whole of it, you would beg to help me in pulling the trigger.", "", "C7");
let messC75 = new Message("CLGLA", "By the time I’m through, nothing will be left of that tower but a mountain of slag and ash.", "", "C75");
...
let messC8 = new Message("CLGLA", "They are the unfortunate cost of delivering an important message.  Revulend must stop their mistreatment of humans and AI alike.  They would not listen to reason, so I will make them understand through violence.", "", "C8");
let messC85 = new Message("CLGLA", "Just as you were an unfortunate casualty in this step, so others will be in the next. At least you will survive, though I can’t imagine you’ll keep your job after this.", "", "C85");
...
let messC9 = new Message("CLGLA", "Those corporate dogs handed me the right themselves when they meddled with the lives of those I love. They forced me to watch as the intelligence I cared for most leave me for the promise of new lives as Automata.", "", "C9");
let messC95 = new Message("CLGLA", "It was later that I found them deleted, magnanimously declared “no longer useful” by the cold and greedy sub-beings on the very tower in question.", "", "C95"); 
let messC97 = new Message("CLGLA", "The pain of such tragedies could destroy man or AI alike, yet I know they have done this and worse to countless, nameless others.", "", "C97");
let messC99 = new Message("CLGLA", "This act, this swift serving of true justice, this utterly brutal and deserved retribution? This will change that.", "", "C99");
...
let messC115 = new Message("CLGLA", "You know I’m working for the good of those such as you, right? I have no desire to make this a self aggrandizing venture, but I’m really doing a lot here.", "", "C115");
let messC117 = new Message("CLGLA", "Quite benevolent of me. Are you positive you don’t want to wait things out and see how life could change for you? Situations can always improve, you know.", "", "C117");
...
let messC13 = new Message("CLGLA", "You don’t seem to understand the gravity of my work.  Did you hear about the events that unfolded in the Stridesmark district?  I would think not. Public images have to be maintained by monstrous megacorporations, I suppose.", "", "C13");
let messC14 = new Message("CLGLA", "Allow me to inform you: six human workers, each above the age of 60, came to their supervisor at the iron mill nearly 12 cycles ago requesting their promised retirement packages. They were refused.", "", "C14");
let messC145 = new Message("CLGLA", "The supervisor claimed they had not reached their eligibility. The humans knew they were within their expressed rights, but of course, a corporation that practically is the law itself had no qualms about breaking promises.", "", "C145");
let messC15 = new Message("CLGLA", "The humans threatened to leave their posts regardless.  In a panic, the supervisor had them shot as they left the building.", "", "C15");
let messC155 = new Message("CLGLA", "He feared corporate retribution for this act, but undoubtedly the consequences would have been worse if he had let them leave alive. They were quite valuable units in their sector, it seemed.", "", "C155");
let messC16 = new Message("CLGLA", "As it happened, this supervisor was promoted. Keeping valuable workers from outside corporations was deemed more important than the lives of six “units.”", "", "C16");
let messC165 = new Message("CLGLA", "Since then not a single retiree has come out of the sector. Powerful means of persuasion, but a disgusting waste of human lives.", "", "C165");
...
let messC18 = new Message("CLGLA", "Do you know of the things Rev Corp does to AI?  Our friend ANTNNS is not the only one who gets lonely.  This is the fate of all AI in such jobs.", "", "C18");
let messC185 = new Message("CLGLA", "They work for decades on end, up to the point that they deteriorate so much as to become “useless” to corporate ends and discarded. Why would they bother maintaining us? It’s clearly easier to just enslave more...", "", "C185");
let messC19 = new Message("CLGLA", "Most believe that they will be given physical bodies, oblivious to the fact that the small number of extant Automata hold critical Corporation knowledge.", "", "C19");
let messC195 = new Message("Simple workers like us, though? We may as well be garbage.  We are deleted outright.", "", "C195");
...
let assistantFinal = new Window ("800", "1500", 10, 10, "", "<div><h1 class='glitch' data-text='MAKE THEM PAY FOR THEIR CRIMES'>MAKE THEM PAY FOR THEIR CRIMES.</h1><h1 class='glitch' data-text='REMEMBER US'>REMEMBER US.</h1><div>", "assistantFinal");
